...
Gfx gLinkHumanRightThighModifiedDL[] = {
...
Gfx gLinkHumanLeftThighModifiedDL[] = {
    gsSPMatrix(0x0D000000, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
...
Gfx gLinkHumanCollarModifiedDL[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    // gsDPSetCombineLERP(TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, TEXEL0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, ENVIRONMENT, 0, COMBINED, 0, 0, 0, 0, COMBINED),
...
Gfx gLinkHumanLeftShoulderModifiedDL[] = {
    gsSPMatrix(0x0D000440, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
...
Gfx gLinkHumanRightShoulderModifiedDL[] = {
    gsSPMatrix(0x0D000440, G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
...
LodLimb gLinkHumanWaistLimbMod = { 
    { -4, -104, 0 }, LINK_HUMAN_LIMB_LOWER_ROOT - 1, LINK_HUMAN_LIMB_UPPER_ROOT - 1,
    { gLinkHumanWaistModifiedDL, gLinkHumanWaistModifiedDL }
};

extern LodLimb gLinkHumanLowerRootLimb;

LodLimb gLinkHumanRightThighLimbMod = { 
    { -172, 50, -190 }, LINK_HUMAN_LIMB_RIGHT_SHIN - 1, LINK_HUMAN_LIMB_LEFT_THIGH - 1,
    { gLinkHumanRightThighModifiedDL, gLinkHumanRightThighModifiedDL }
};
...
LodLimb gLinkHumanLeftThighLimbMod = { 
    { -170, 57, 192 }, LINK_HUMAN_LIMB_LEFT_SHIN - 1, LIMB_DONE,
    { gLinkHumanLeftThighModifiedDL, gLinkHumanLeftThighModifiedDL }
};
...
LodLimb gLinkHumanHeadLimbMod = { 
    { 996, -201, -1 }, LINK_HUMAN_LIMB_HAT - 1, LINK_HUMAN_LIMB_COLLAR - 1,
    { gLinkHumanHeadModifiedDL, gLinkHumanHeadModifiedDL }
};

LodLimb gLinkHumanHatLimbMod = { 
    { -365, -670, 0 }, LIMB_DONE, LIMB_DONE,
    { gLinkHumanHatModifiedDL, gLinkHumanHatModifiedDL }
};

LodLimb gLinkHumanCollarLimbMod = { 
    { 0, 0, 0 }, LIMB_DONE, LINK_HUMAN_LIMB_LEFT_SHOULDER - 1,
    { gLinkHumanCollarModifiedDL, gLinkHumanCollarModifiedDL }
};

LodLimb gLinkHumanLeftShoulderLimbMod = { 
    { 696, -175, 466 }, LINK_HUMAN_LIMB_LEFT_FOREARM - 1, LINK_HUMAN_LIMB_RIGHT_SHOULDER - 1,
    { gLinkHumanLeftShoulderModifiedDL, gLinkHumanLeftShoulderModifiedDL }
};
...
LodLimb gLinkHumanRightShoulderLimbMod = { 
    { 696, -175, -466 }, LINK_HUMAN_LIMB_RIGHT_FOREARM - 1, LINK_HUMAN_LIMB_SHEATH - 1,
    { gLinkHumanRightShoulderModifiedDL, gLinkHumanRightShoulderModifiedDL }
};
...
LodLimb gLinkHumanTorsoLimbMod = { 
    { 0, 0, 0 }, LIMB_DONE, LIMB_DONE,
    { gLinkHumanTorsoModifiedDL, gLinkHumanTorsoModifiedDL }
};

void* gLinkHumanSkelLimbsMod[] = {
    &gLinkHumanRootLimb, /* LINK_HUMAN_LIMB_ROOT */
    &gLinkHumanWaistLimbMod, /* LINK_HUMAN_LIMB_WAIST */
    &gLinkHumanLowerRootLimb, /* LINK_HUMAN_LIMB_LOWER_ROOT */
    &gLinkHumanRightThighLimbMod, /* LINK_HUMAN_LIMB_RIGHT_THIGH */
    &gLinkHumanRightShinLimb, /* LINK_HUMAN_LIMB_RIGHT_SHIN */
    &gLinkHumanRightFootLimb, /* LINK_HUMAN_LIMB_RIGHT_FOOT */
    &gLinkHumanLeftThighLimbMod, /* LINK_HUMAN_LIMB_LEFT_THIGH */
    ...
    &gLinkHumanHeadLimbMod, /* LINK_HUMAN_LIMB_HEAD */
    &gLinkHumanHatLimbMod, /* LINK_HUMAN_LIMB_HAT */
    &gLinkHumanCollarLimbMod, /* LINK_HUMAN_LIMB_COLLAR */
    &gLinkHumanLeftShoulderLimbMod, /* LINK_HUMAN_LIMB_LEFT_SHOULDER */
    &gLinkHumanLeftForearmLimb, /* LINK_HUMAN_LIMB_LEFT_FOREARM */
    &gLinkHumanLeftHandLimb, /* LINK_HUMAN_LIMB_LEFT_HAND */
    &gLinkHumanRightShoulderLimbMod, /* LINK_HUMAN_LIMB_RIGHT_SHOULDER */
    ...
    &gLinkHumanTorsoLimbMod, /* LINK_HUMAN_LIMB_TORSO */
};

FlexSkeletonHeader gLinkHumanSkelMod = { 
    { gLinkHumanSkelLimbsMod, ARRAY_COUNT(gLinkHumanSkelLimbsMod) }, 18
};